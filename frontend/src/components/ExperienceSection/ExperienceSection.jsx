...
//     }));
//   };
//   // update experience all functionality
...
//     try {
//       // Merge new experience with existing ones before sending the PUT request
...
//       // Update the experience section with the newly added experience
//       setProfileToEdit((prevState) => ({
//         ...prevState,
//         experience: updatedExperience, // Updating profile with the merged experiences
//       }));
...
const ExperienceSection = ({ userData, authUser }) => {
  ...
  const handleDeleteExperience = async (id) => {
    ...
    try {
      const updatedExperience = profileToEdit.experience.filter((exp) => exp._id !== id);
